...
<html>
<head>
<title>Longrich Bénin | Statistique/Utilisateur </title>
	...
	<div class="main-content">
		...
		<div id="page-wrapper">
            <span class="col-md-10">
                <h3 class="title1">Statistique/Utilisateur</h3>
            </span>
				...
				<div class="col-md-4 compose-left">
					<div class="folder widget-shadow">
						<ul>
                            ...
                            <li>
                                <a href="{{ route('user.admin.statistic') }}">
									<div class="chat-left">
                            ...
                            @foreach ($users as $user)
                                <li>
                                    <a href="{{ route('user.all.statistic', $user['id']) }}">
                                        <div class="chat-left">
                                            <img class="img-circle" src="{{asset('images_admin/a.png')}}" style="width:34px; height:34px;" alt="">
                                        </div>
                                        <div class="chat-right">
