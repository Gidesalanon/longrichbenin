...
<!-- //font-awesome icons -->
 <!-- js-->
<script src="js_admin/jquery-1.11.1.min.js"></script>
<script src="js_admin/modernizr.custom.js"></script>
<!--webfonts-->
<link href='//fonts.googleapis.com/css?family=Roboto+Condensed:400,300,300italic,400italic,700,700italic' rel='stylesheet' type='text/css'>
<!--//webfonts-->
<!--animate-->
<link href="css_admin/animate.css" rel="stylesheet" type="text/css" media="all">
<script src="js_admin/wow.min.js"></script>
	<script>
		 new WOW().init();
	</script>
<!--//end-animate-->
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<h3 class="title1">Bonjour {{Auth::user()->prenom}} !</h3>
				<div class="blank-page widget-shadow scroll" id="style-2 div1">
					<p>Votre enregistrement a été éffectué avec succès. Veuillez attendre l'approbation de l'administrateur.
					</p>
				</div>
			</div>
		</div>
	...
	<!-- Classie -->
		<script src="js_admin/classie.js"></script>
		<script>
	...
	<!--scrolling js-->
	<script src="js_admin/jquery.nicescroll.js"></script>
