...
<html>
<head>
<title>Longrich Bénin | Nouvelle Commande :: Admin</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Nouvelle Commande</h3>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms">
						...
						<div class="form-title">
							<h4>Créer une nouvelle commande:</h4>
						</div>
						<div class="form-body">
						@include('order.order-multiFields')
						</div>
					</div>
				</div>
			</div>
