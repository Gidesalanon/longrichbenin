...
<html>
<head>
<title>Longrich Bénin | Liste des stocks :: Admin</title>
                ...
                <div class="tables">
					...
					<div class="table-responsive bs-example widget-shadow">
						...
						<table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#modalDeleteStock{{ $stock['id']}}">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4">Aucun Stock ajouté pour le moment.</td>
                                </tr>
                            @endforelse
                        </table>
